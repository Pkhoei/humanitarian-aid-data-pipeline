...
- Visualize **key indicators** (aid amount, region coverage, population served) using Power BI



### ⚙️ Tech Stack
- **Languages:** Python, SQL  
- **Tools:** Pandas, dbt (local), Power BI, Azure (simulation), GitHub Actions  
- **Libraries:** NumPy, Pandas, Matplotlib, Scikit-learn



### 📊 Pipeline Stages
1️⃣ **Data Ingestion** – from open humanitarian data sources  
2️⃣ **Data Cleaning & Quality Checks** – duplicates, nulls, format consistency  
3️⃣ **Transformation & Modelling** – dbt or Pandas workflows  
4️⃣ **Visualization & Insights** – Power BI Dashboard  
